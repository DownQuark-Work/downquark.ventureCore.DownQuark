...
class config
{
    ...
    public $sitename = 'DownQuark';                        //Name of your site, can be changed later
    ...
    public $dbUser = 'mlnck';                                  //Database username
    public $dbPassword = 'DownQu@rk!';                              //Database password
    public $dbDatabase = 'downquark_leantime';                              //Database name
